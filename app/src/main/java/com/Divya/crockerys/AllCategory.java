...
import com.Divya.crockerys.adapter.AllCategoryAdapter;
import com.Divya.crockerys.model.AllCategoryModel;
...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(1, R.drawable.e1));
        allCategoryModelList.add(new AllCategoryModel(2, R.drawable.e15));
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.cc1));
        allCategoryModelList.add(new AllCategoryModel(4, R.drawable.c3));
        allCategoryModelList.add(new AllCategoryModel(5, R.drawable.e20));
        allCategoryModelList.add(new AllCategoryModel(6, R.drawable.e7));
        allCategoryModelList.add(new AllCategoryModel(7, R.drawable.e3));
        allCategoryModelList.add(new AllCategoryModel(8, R.drawable.k4));
        allCategoryModelList.add(new AllCategoryModel(8, R.drawable.k8));
